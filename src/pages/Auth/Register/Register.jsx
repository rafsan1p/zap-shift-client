        ...
        <div className="w-full">
            ...
            <form onSubmit={handleSubmit(handleRegistration)} className="flex flex-col gap-4">
                ...
                <div>
                    ...
                    <input type="password" {...register('password', {required: true, minLength: 6})} placeholder="Password" className="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm outline-none focus:border-[#CAEB45] transition" />
